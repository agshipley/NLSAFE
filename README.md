...
- [`bep_to_slsa`]([./NLSAFE_integration_layer/provenance/bep_to_slsa)](https://github.com/agshipley/NLSAFE/tree/3346b48752764fbfe6e8f384dc799763fd092ac0/BEP%20-%20SLSA%20interpreter): Transformer that converts Bazel Build Event Protocol (BEP) data into SLSA provenance format for cryptographically verifiable build records (Rust).
